...
* subject only Reference(USCorePractitionerProfile)  // Child, Fetus, or Decedent
...
* focus only Reference(USCorePractitionerProfile or USCoreRelatedPersonProfile) //not required, may be omitted if reporting education level of decedent, not parent. 
