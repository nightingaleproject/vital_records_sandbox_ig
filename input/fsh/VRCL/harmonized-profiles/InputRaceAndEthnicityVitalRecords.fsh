Profile: InputRaceAndEthnicityVitalRecords
Parent: Observation
Id: vr-input-race-and-ethnicity
Title: "Input Race and Ethnicity Vital Records"
...
* subject only Reference(USCorePatientProfile) // decedent, mother
* focus only Reference(USCoreRelatedPersonProfile) // father
