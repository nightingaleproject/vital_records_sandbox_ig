...
InstanceOf: ProcedureDeathCertificationVitalRecords
...
* performer
  ...
  * actor = Reference(practitioner-vital-records-janet-seito-common) // "Practitioner/us-core-practitioner-vr-s-jones"