...
//   * ^short = "This slice contains demographic information about the decedent that is not represented in the decedent Patient profile."
//   * ^definition = "This section contains demographic information about the decedent that is not represented in the decedent Patient profile."
//   * code 1..1 // This cardinality reflects what is in the published IG: https://build.fhir.org/ig/HL7/fhir-mdi-ig/StructureDefinition-Composition-mdi-to-edrs.html,
//               // and not what is in the MDI repo: https://github.com/HL7/fhir-mdi-ig/blob/master/input/resources/structuredefinition/Composition-mdi-to-edrs.xml
//   * code = CodeSystemMDI#demographics
//     * ^definition = "Demographic information section"
//     * text
//       * ^label = "A	Plain text representation of the concept"
//       * ^short = "	Plain text representation of the concept"
//       * ^definition = "	Plain text representation of the concept"
//   * text
//     * ^label = "Text summary of the section, for human interpretation"
//     * ^short = "Text summary of the section, for human interpretation"
//     * ^definition = "Text summary of the section, for human interpretation"

// * insert MDICompositionSectionEntrySlicing(circumstances)
// * insert MDICompositionSectionEntrySlicing(jurisdiction)
// * insert MDICompositionSectionEntrySlicing(cause-manner)
// * insert MDICompositionSectionEntrySlicing(medical-history)
// * insert MDICompositionSectionEntrySlicing(exam-autopsy)
...
// //* insert BundleSectionSlice(exam-autopsy, autopsy-performed, 0, *, autopsy-performed, autopsy-performed, ObservationAutopsyPerformedIndicator)
// //* insert BundleSectionSlice(exam-autopsy, autopsy-location, 0, *, autopsy-location, autopsy-location, USCoreLocation or USCoreOrganizationProfile)
// // Exam autopsy lacks emptyReason field

// * section[exam-autopsy] ^label = "This slice contains exam and autopsy information."
//   * ^short = "This slice contains exam and autopsy information."
//   * ^definition = "This section contains exam and autopsy information."
//   // cardinality reflects
//   * code 1..1 
//   * code = CodeSystemMDI#exam-autopsy
//     * ^definition = "Exam/Autopsy section"
//   * text ..1 
...
//     * ^slicing.discriminator.path = "$this.resolve()"
//     * ^slicing.rules = #open
//   * entry contains autopsy-performed 0..* 
