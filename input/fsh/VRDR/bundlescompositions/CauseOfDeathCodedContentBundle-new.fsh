Profile: CauseOfDeathCodedContentBundleNew
Parent: Bundle
Id: vrdr-cause-of-death-coded-bundle-new
...
// Input Content
* insert BundleSlice(  CauseOfDeathPart1,  0, 4,  CauseOfDeathPart1,  CauseOfDeathPart1,  ObservationCauseOfDeathPart1VitalRecordsNew)
//* insert BundleSlice(  CauseOfDeathPathway,  0, 1,  CauseOfDeathPathway,  CauseOfDeathPathway,  CauseOfDeathPathway)
* insert BundleSlice(  CauseOfDeathPart2,  0, 1,  CauseOfDeathPart2,  CauseOfDeathPart2,  ObservationCauseOfDeathPart2VitalRecordsNew)
* insert BundleSlice(  MannerOfDeath,  0, 1,  MannerOfDeath,  MannerOfDeath,  ObservationMannerOfDeathVitalRecordsNew)
...
* insert BundleSlice(  DeathCertification,  0, 1,  DeathCertification,  DeathCertification,  ProcedureDeathCertificationVitalRecordsNew)
* insert BundleSlice(  InjuryIncident,  0, 1,  InjuryIncident,  InjuryIncident,  ObservationInjuryIncidentVitalRecordsNew)
* insert BundleSlice(  TobaccoUseContributedToDeath,  0, 1,  TobaccoUseContributedToDeath,  TobaccoUseContributedToDeath,  ObservationTobaccoUseContributedToDeathVitalRecordsNew)
* insert BundleSlice(  DecedentPregnancyStatus,  0, 1,  DecedentPregnancyStatus,  DecedentPregnancyStatus,  ObservationDecedentPregnancyVitalRecordsNew)
