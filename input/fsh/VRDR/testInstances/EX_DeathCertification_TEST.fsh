...
Instance: DeathCertification-Example1-TEST
InstanceOf: DeathCertification
Usage: #example
Description: "DeathCertification Example1-TEST"
...
* performer.actor = Reference(Certifier-Example1-TEST)

Instance: DeathCertification-Example2-TEST
InstanceOf: DeathCertification
Usage: #example
Description: "DeathCertification Example2-TEST"
* insert AddMetaProfile(DeathCertification)
* identifier.value = "180"
* status = #completed
* category = $sct#103693007 "Diagnostic procedure"
