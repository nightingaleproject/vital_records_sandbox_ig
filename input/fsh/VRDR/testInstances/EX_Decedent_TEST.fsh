Instance: Decedent-Example3-TEST
InstanceOf: Decedent
Usage: #example
Description: "Decedent-Example3 - Stripped down for Mortality Roster-TEST"
...
Instance: Decedent-Example2-TEST
InstanceOf: Decedent
Usage: #example
Description: "Decedent-Example2 - with birth jurisdiction-TEST"
* insert AddMetaProfile(Decedent)
* extension[Spouse-Alive].valueCodeableConcept = $v2-0136#Y
* extension[NVSS-SexAtDeath].valueCodeableConcept = $admingender#unknown "Unknown"
* extension[$patient-birthPlace].valueAddress.city = "Brooklyn"
...
Instance: Decedent-Example1-TEST
InstanceOf: Decedent
Usage: #example
Description: "Decedent-Example1-TEST"
* insert AddMetaProfile(Decedent)
* extension[Spouse-Alive].valueCodeableConcept = $v2-0136#Y
* extension[NVSS-SexAtDeath].valueCodeableConcept = $admingender#unknown "Unknown"
