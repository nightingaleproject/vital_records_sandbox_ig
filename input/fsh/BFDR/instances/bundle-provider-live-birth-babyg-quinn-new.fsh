...
* entry[+]
  ...
  * resource = Inline-Instance-for-bundle-provider-live-birth-babyg-quinn-40
* entry[+]
  * fullUrl = "http://example.org/fhir/Observation/observation-infant-living-babyg-quinn"
  * resource = Inline-Instance-for-bundle-provider-live-birth-babyg-quinn-41
* entry[+]
  * fullUrl = "http://example.org/fhir/Observation/observation-infant-breastfed-at-discharge-babyg-quinn"
  * resource = Inline-Instance-for-bundle-provider-live-birth-babyg-quinn-42
* entry[+]
  * fullUrl = "http://example.org/fhir/Observation/observation-mother-married-during-pregnancy-jada-ann-quinn"
  * resource = Inline-Instance-for-bundle-provider-live-birth-babyg-quinn-43
* entry[+]
