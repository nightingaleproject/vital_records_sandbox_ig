...
//   * entry[editFlagFathersDateOfBirth] = Reference(Observation/observation-edit-flag-fathers-date-of-birth-example) "Observation - Edit flag father's date of birth"
//   * entry[editFlagFathersEducation] = Reference(Observation/observation-edit-flag-fathers-education-example) "Observation - Edit flag father's education"
...
//   * entry[editFlagMothersDeliveryWeight] = Reference(Observation/observation-edit-flag-mothers-delivery-weight-example) "Observation - Edit flag mother's delivery weight"
