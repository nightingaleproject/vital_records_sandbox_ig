...
Title: "Observation - Cigarette Smoking Before During Pregnancy example [last 3 months: Carmen Teresa Lee]"
Description: "Example of Observation-cigarette-smoking-before-during-pregnancy profile (last 3 months: Carmen Teresa Lee)"
Usage: #example
* status = #final
