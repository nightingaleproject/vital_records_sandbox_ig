Instance: Inline-Instance-for-bundle-jurisdiction-live-birth-babyg-quinn-46
InstanceOf: RelatedPerson
Usage: #inline
* id = "relatedperson-father-natural-james-brandon-quinn"
* meta.profile = "http://hl7.org/fhir/us/vr-common-library/StructureDefinition/RelatedPerson-father-natural-vr"
* extension[0]
  * extension[0]
    * url = "ombCategory"
