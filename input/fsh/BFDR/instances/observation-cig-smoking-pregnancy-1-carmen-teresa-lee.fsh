...
Title: "Observation - Cigarette Smoking Before During Pregnancy example [3 months prior: Carmen Teresa Lee]"
Description: "Example of Observation-cigarette-smoking-before-during-pregnancy profile (3 month prior: Carmen Teresa Lee)"
Usage: #example
* status = #final
