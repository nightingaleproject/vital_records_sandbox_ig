Instance: Inline-Instance-for-bundle-provider-fetal-death-not-named-32
InstanceOf: QuestionnaireResponse
Usage: #inline
* id = "QuestionnaireResponse-patients-fetal-death-carmen-lee"
...
* item[+]
  ...
  * answer.valueCoding = urn:oid:2.16.840.1.114222.4.5.274#PHC1449 "9th through 12th grade; no diploma"
* item[+]
