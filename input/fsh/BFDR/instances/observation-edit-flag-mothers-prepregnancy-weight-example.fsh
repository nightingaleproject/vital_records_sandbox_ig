Instance: observation-edit-flag-mothers-prepregnancy-weight-example
InstanceOf: ObservationEditFlagMothersPrepregnancyWeight
Title: "Edit Flag - Mother's Prepregnancy Weight"
Description: "Edit Flag - Mother's Prepregnancy Weight example"
Usage: #example
* status = #final
