...
* participant[0]
  ...
  * individual = Reference(practitioner-vital-records-avery-jones)
...
* hospitalization
  * destination = Reference(location-east-hospital)
...
* partOf = Reference(encounter-maternity-jada-ann-quinn)
