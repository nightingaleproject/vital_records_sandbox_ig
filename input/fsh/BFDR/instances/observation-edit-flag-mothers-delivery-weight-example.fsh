Instance: observation-edit-flag-mothers-delivery-weight-example
InstanceOf: ObservationEditFlagMothersDeliveryWeight
Title: "Edit Flag - Mother's Delivery Weight"
Description: "Edit Flag - Mother's Delivery Weight example"
Usage: #example
* meta
  * versionId = "2"
