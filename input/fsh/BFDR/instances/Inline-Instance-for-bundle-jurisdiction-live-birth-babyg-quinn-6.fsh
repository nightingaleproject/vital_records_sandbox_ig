Instance: Inline-Instance-for-bundle-jurisdiction-live-birth-babyg-quinn-6
InstanceOf: Patient
Usage: #inline
* id = "patient-mother-jada-ann-quinn"
* meta.profile = "http://hl7.org/fhir/us/vr-common-library/StructureDefinition/Patient-mother-vr"
* extension[0]
  * extension[0]
    * url = "ombCategory"
