...
* insert addentry(ObservationEditFlagEstimateOfGestation, observation-edit-flag-estimate-of-gestation-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagFathersDateOfBirth, observation-edit-flag-fathers-date-of-birth-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagFathersEducation, observation-edit-flag-fathers-education-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagMothersDateOfBirth, observation-edit-flag-mothers-date-of-birth-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagMothersDeliveryWeight, observation-edit-flag-mothers-delivery-weight-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagMothersEducation, observation-edit-flag-mothers-education-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagMothersHeight, observation-edit-flag-mothers-height-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagMothersPrepregnancyWeight, observation-edit-flag-mothers-prepregnancy-weight-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagNumberPrenatalCareVisits, observation-edit-flag-number-prenatal-care-visits-example)
// * entry[+]
...
* insert addentry(ObservationEditFlagPlurality, observation-edit-flag-plurality-example)
// * entry[+]
