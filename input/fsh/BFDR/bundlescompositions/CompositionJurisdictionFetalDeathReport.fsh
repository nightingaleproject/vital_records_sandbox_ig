...
* extension 1.. MS
  ...
  * ^slicing.rules = #open
* extension contains
    ExtensionFetalDeathReportNumber named fetalDeathReportNumber 1..1 MS and
...
* section[fetus] ^short = "Fetus Section on the Fetal Death Report"
  ...
  * entry contains
      ...
      estimatedTimeFetalDeath 0..1 MS and
...
* section[editFlags] ^short = "Edit Flags Section"
  ...
  * entry ..8 MS
    ...
    * ^slicing.rules = #open
  * entry contains
      editFlagWeightOfFetus 1..1 MS and
      editFlagEstimateOfGestation 1..1 MS and
      editFlagMothersDateOfBirth 1..1 MS and
      editFlagMothersEducation 1..1 MS and
      editFlagMothersHeight 1..1 MS and
      editFlagMothersPrepregnancyWeight 1..1 MS and
      editFlagNumberPreviousCesareans 1..1 MS and
      editFlagPlurality 1..1 MS
