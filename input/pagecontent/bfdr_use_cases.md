...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ----------------------------------- |
| Provider Live Birth           | [Composition - Provider Live Birth Report][CompositionProviderLiveBirthReportNew]                   | EHR                                 | Jurisdictional Vital Records Office |
| Provider Fetal Death          | [Composition - Provider Fetal Death Report][CompositionProviderFetalDeathReportNew]              | EHR                                 | Jurisdictional Vital Records Office |
| Jurisdiction Live Birth       | [Composition - Jurisdiction Live Birth Report][CompositionJurisdictionLiveBirthReportNew]          | Jurisdictional Vital Records Office | National Statistical Agency         | 
| Jurisdiction Fetal Death      | [Composition - Jurisdiction Fetal Death Report][CompositionJurisdictionFetalDeathReportNew]                  | Jurisdictional Vital Records Office | National Statistical Agency         | 
| Coded Race and Ethnicity      | [Composition - Coded Race and Ethnicity][CompositionCodedRaceAndEthnicityNew]                       | National Statistical Agency         | Jurisdictional Vital Records Office |
| Coded Cause of Fetal Death    | [Composition - Coded Cause of Fetal Death][CompositionCodedCauseOfFetalDeathNew]                  | National Statistical Agency         | Jurisdictional Vital Records Office |
...
The Provider Live Birth use case is represented by the [Composition - Provider Live Birth Report][CompositionProviderLiveBirthReportNew]  .
...
The Jurisdiction Live Birth use case is represented by the [Composition - Jurisdiction Live Birth Report][CompositionJurisdictionLiveBirthReportNew] .
...
The Provider Fetal Death use case is represented by the [Composition - Provider Fetal Death Report][CompositionProviderFetalDeathReportNew]  .
...
The Jurisdiction Fetal Death use case is represented by the [Composition - Jurisdiction Fetal Death Report][CompositionJurisdictionFetalDeathReportNew]  .
...
The Coded Race and Ethnicity use case is represented by the [Composition - Coded Race and Ethnicity][CompositionCodedRaceAndEthnicityNew]  . ***Note:*** requirements for this workflow are in development and the FHIR Composition profile may change.  
...
The Coded Cause of Fetal Death use case is represented by the [Composition - Coded Cause of Fetal Death][CompositionCodedCauseOfFetalDeathNew] . ***Note:*** requirements for this workflow are in development and the FHIR Composition profile may change.
