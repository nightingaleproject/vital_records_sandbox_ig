...
| :---------: | --------------- | ------------ | ------------- | ---------- | ---------- | -------------- |
| Natality | 158 | Risk Factors--Gestational Diabetes | GDIAB |  |na |See [Note on missing data] |
| Fetal Death | 111 | Risk Factors--Gestational Diabetes | GDIAB |  |na |See [Note on missing data] |
{: .grid }
