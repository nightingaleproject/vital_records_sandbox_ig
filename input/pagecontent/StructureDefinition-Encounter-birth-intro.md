...
| Natality | 231 | Was Infant Transferred Within 24 Hours of Delivery? | ITRAN | hospitalization.dischargeDisposition="other-hcf" |codeable |[http://hl7.org/fhir/us/core/ValueSet/us-core-discharge-disposition]. See [Note on missing data]. Need to discuss - clarity needed for values other than 'other-hcf' |
